(function() {
	...
	var AIconfont = /*#__PURE__*/ (function(_Component) {
		_inheritsLoose(AIconfont, _Component);
		function AIconfont() {
			var _this;
			for (
		...
		var _proto = AIconfont.prototype;
		_proto.css = function css() {
			return ".a-iconfont {font-family: iconfont;}";
		};
		return AIconfont;
	})(Component);
	...
	var Tpl = /*@__PURE__*/ (function(Component) {
		...
		Tpl.prototype.render = function() {
			return apivm.h(
				...
				apivm.h("text", {class: "t"}, "sdf"),
				apivm.h("a-iconfont", {name: "mine"}),

				apivm.h("view", {style: "width:100px;height:20px;border:1px dashed red;"})
			);
		};
